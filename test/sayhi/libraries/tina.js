...
var Page$1 = function (_Basic) {
  ...
  createClass(Page, null, [{
    ...
    value: function define() {
      ...
      var page = _extends({}, methods(options.methods), lifecycles(MINA_PAGE_HOOKS.filter(function (name) {
  ...
  function Page(_ref) {
    ...
    }, options.methods, mapObject(pick(options, PAGE_HOOKS), function (handlers, name) {
      return function () {
        var _this2 = this;
...
var Component$1 = function (_Basic) {
  ...
  function Component(_ref) {
    ...
    }, options.methods, mapObject(pick(options, COMPONENT_HOOKS), function (handlers, name) {
      return function () {
        var _this2 = this;
